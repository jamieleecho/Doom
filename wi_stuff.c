...
boolean2 WI_Responder(event_t* ev)
{
    return false;
}
...
static boolean2		snl_pointeron = false;
...
void WI_drawStats(void)
{
    ...
    V_DrawPatch(SP_TIMEX, SP_TIMEY, FB, doom_time);
...
void WI_loadData(void)
{
    ...
    // "time"
    doom_time = W_CacheLumpName("WITIME", PU_STATIC);   
...
void WI_unloadData(void)
{
    ...
    Z_ChangeTag(doom_time, PU_CACHE);
